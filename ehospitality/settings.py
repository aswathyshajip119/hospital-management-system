...
Generated by 'django-adminpanel startproject' using Django 4.2.29.
...
SECRET_KEY = 'django-insecure-6s0gw4(w25_$l$0pi-6s6zqdwp_@q5%2#ivmsynn(q^u=567-y'
...
INSTALLED_APPS = [
    ...
    'django.contrib.staticfiles','patient','doctor','adminpanel',
]
